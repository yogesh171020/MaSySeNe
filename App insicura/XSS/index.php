...
?>   
    <div class="row">
        <div class="col-md-12">
            <textarea class="form-control" id="mainComment" placeholder="Inserisci un messaggio" cols="30" rows="2"></textarea><br>
    ...
    <div class="row replyRow" style="display:none">
        <div class="col-md-12">
            <textarea class="form-control" id="replyComment" placeholder="Inserisci un commento" cols="30" rows="2"></textarea><br>
