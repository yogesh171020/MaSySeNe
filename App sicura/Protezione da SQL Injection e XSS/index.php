...
function createCommentRow($data) {
    ...
    $response = '
            <div class="comment">
                ...
                <div class="reply"><a href="javascript:void(0)" data-commentID="'.$data['id'].'" onclick="reply(this)">COMMENTA</a></div>
                <div class="replies">';
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Pagina di registrazione</h5>
            </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" id="registerBtn">Registrati</button>
...
<div class="container" style="margin-top:50px;">
    <div class="row">
        <div class="col-md-12" align="right">
            ...
            if (!$loggedIn)
                echo '
                        <button class="btn btn-primary" data-toggle="modal" data-target="#registerModal">Registrazione</button>
                        <button class="btn btn-success" data-toggle="modal" data-target="#logInModal">Accedi</button>
                ';
            else
                echo '
                    <a href="logout.php" class="btn btn-warning">Esci</a>
                ';
            ?>
        </div>
    </div><br>
...
<script>
    ...
    <div class="row">
        <div class="col-md-12">
            <textarea class="form-control" id="mainComment" onkeyup="lettersOnly(this)" placeholder="Inserisci un messaggio" cols="30" rows="2"></textarea><br>
            <button style="float:right" class="btn-primary btn" onclick="isReply = false;" id="addComment">Aggiungi messaggio</button>
        </div>
    </div>   
                              
    <div class="row">
        <div class="col-md-12">
            <h2><b id="numComments"><?php echo $numComments ?> Messaggi</b></h2>
    ...
    <div class="row replyRow" style="display:none">
        <div class="col-md-12">
            <textarea class="form-control" id="replyComment" onkeyup="lettersOnly(this)" placeholder="Inserisci un commento" cols="30" rows="2"></textarea><br>
            <button style="float:right" class="btn-primary btn" onclick="isReply = true;" id="addReply">Aggiungi commento</button>
            <button style="float:right" class="btn-default btn" onclick="$('.replyRow').hide();">Chiudi</button>
        </div>
    </div>
<?php
    }
    ...
    $(document).ready(function () {
        $("#addComment, #addReply").on('click', function () {
            ...
            if (comment.length > 5) {
                ...
                alert('Inserisci un messaggio più lungo');
        });
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        if (response === 'failedEmail')
                            ...
                            alert('Esiste già un utente con questo inidirizzo email!');
                        else
            ...
            if (email != "" && password != "") {
                $.ajax({
                    ...
                    data: {
                        ...
                        if (response === 'failed')
                            alert('Controlla i tuoi dati di accesso!');
                        else
                            window.location = window.location;
                    }
                });
